...
/**
 * AdminMenu.tsx - Fixed Admin Menu with proper sizing
...
import {
  Settings, User, Database, FileText, MessageCircle, Gift, Zap, Plus, Save, Trash2, X, Edit
} from "lucide-react";
...
export default function AdminMenu({ onClose, onCreateCharacter, onEditCharacter }: AdminMenuProps) {
  ...
  return (
    <div className="fixed inset-4 bg-gray-900/95 border border-purple-500/30 rounded-xl shadow-2xl backdrop-blur-sm z-50 flex flex-col">
      {/* Header */}
      ...
      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1 p-4">
        ...
        {/* Characters Tab */}
        <TabsContent value="characters" className="flex-1 overflow-auto space-y-4">
          <Card className="bg-black/20 border-purple-500/30">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                {newCharacter.image && (
                  <img src={newCharacter.image as string} alt="Preview" className="w-20 h-20 object-cover mt-2 rounded" />
                )}
              </div>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  onClick={() => onEditCharacter?.(newCharacter)}
        ...
        {/* Game Management Tab */}
        <TabsContent value="game" className="flex-1 overflow-auto space-y-4">
          <Card className="bg-black/20 border-purple-500/30">
            <CardHeader>
        ...
        {/* Misc Tab */}
        <TabsContent value="misc" className="flex-1 overflow-auto space-y-4">
          <Card className="bg-black/20 border-purple-500/30">
            <CardHeader>
