...
import { Send, Image, Heart, Settings, Trash2, RefreshCw, Camera, Smile } from "lucide-react";
...
export function AIChat ({ userId, selectedCharacterId }: AIChatProps) {
  ...
  const getResponsesForMood = (mood: string): string[] => {
    ...
    const moodResponses: Record<string, string[]> = {
      normal: character.customResponses?.length ? character.customResponses : [
        "I understand what you mean.",
        "That's interesting to hear.",
        "I appreciate you sharing that with me."
      ],
      happy: [
        "That makes me so happy! 馃槉",
        "Yay! I love hearing good news! 鉁�",
        "You always know how to brighten my day! 馃挄"
      ],
      flirty: [
        "You're so sweet... 馃槝",
        "I love talking with someone as charming as you 馃挅",
        "You always make my heart flutter~ 馃挄"
      ],
      playful: [
        "Hehe, you're so silly! 馃槃",
        "Let's have some fun together! 馃帀",
        "I love your playful side! 馃構"
      ],
      mysterious: [
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              {character.responseTimeMin === character.responseTimeMax ? (
                ...
                <span>{character.responseTimeMin}-{character.responseTimeMax}s response time</span>
              )}
...
// Chat Settings Dialog Component
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) => 
              onSettingsChange({ ...settings, responseDelay: checked })
            }
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) => 
              onSettingsChange({ ...settings, pictureSending: checked })
            }
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) => 
              onSettingsChange({ ...settings, moodAdaptation: checked })
            }
          />
        </div>
      </div>
